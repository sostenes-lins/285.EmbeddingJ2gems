...
\caption{\sf $wbp$-move: balloon's head section is painted in gray, 
...
\caption{\sf The general $wbp$-move: the {\em star} \index{star} of a vertex of a graph embedded in an onrientable
