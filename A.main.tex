...
The initial wing $\mathcal{W}_1=\mathcal{W}'_1 \cup \mathcal{W}''_1$ is formed by 
$2n$-edges linking $a_1$ to $Z$ and $2n$ edges linking 
$b_1$ to $Z$. We also have $\mathcal{N}_1=\varnothing$. At each $wbp$-move two new vertices
and 2 new edges are added when going from $\mathcal{S}_{m-1}$ to $\mathcal{S}_{m}$ according to
the scheme of Fig. \ref{fig:controlmaps01novo2} and the control of the thinning of a blob 
in the combinatorics of the involved $J^2B$-gems. We arrive to a combinatorial embedding of
$\mathcal{S}_n$ given by a rotation. We need to make $\mathcal{S}_n$ geometric.
