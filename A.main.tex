...
the figure despicts the final pair of wings $\mathcal{W}$. 
...
linear algorithm explained in Subection \ref{subsec:diamondW}. 
}
...
\begin{figure}[H] 
\begin{center}
\includegraphics[width=14cm]{A.figs/coordX.pdf}
